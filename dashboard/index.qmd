...
# Identify batches (sorted descending)
...
# Recent batches for sparklines (last 6)
recent <- tail(batch_summ, 6)
...
value_box(
  title = "Avg Cost/Bird (Last 6 Batches, UGX)",
...
```{r}
#| title: Financial Summary — All Batches
...
```{r}
#| title: Profit & Loss Statement — All Batches
